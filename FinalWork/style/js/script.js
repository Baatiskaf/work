...
let sliderImage = $('.slider__images-image');
...
// set up vars
let sliderPagers = 'ol.js__slider__pagers li',
...
function checkImageHeight() {
    let sliderHeight = $('.slider__images-image:visible').height();
...
// slider autoplay
let timingRun = setInterval(function () {
    sliderTiming();
}, sliderSpeed);
